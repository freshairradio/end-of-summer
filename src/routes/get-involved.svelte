...
<div class="duration-200 transition-opacity ">
  ...
  <div
    ...
    <p>
      ...
      with FreshAir, from presenting a show to managing music tech. If you're
      interested or you want to know more, get in touch on
      ...
      , or send an email to
      <a href="mailto:manager@freshair.org.uk">manager@freshair.org.uk</a>
      . You can also use this handy form!
    </p>
    {#if !done}
      <input
